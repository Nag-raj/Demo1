...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
String strResponseURL = "XIeCommerce3RS.jsp";
...
try
{
	...
	packetRS = AccessTokenUtility.GetPostAccessToken(XIConfig.CC_GUID.get(), XIConfig.CC_PSK.get(), XIConfig.URL.get(), packetRQ);
...
<html>
    <head>
		...
		<title>XiIntercept v3 - FORM-POST Request</title>
    </head>
    ...
    <body>
        <form>
            <div class="sampleBodyShrinkToFit">
                 <p>
                     <label for="PaymentType">Credit Card:</label><input type="text" id="CardNo" name="CardNo" value="" class="ccfields" /></p>
                 <p>
                <br/> 
