...
try
{
    ...
    xml = AccessTokenUtility.GetResponsePacket(XIConfig.CC_GUID.get(), XIConfig.CC_PSK.get(), XIConfig.URL.get(), accessToken);
...
<html>
	<head>
		...
		<title>XiIntercept v3 - FORM-POST Response</title>
